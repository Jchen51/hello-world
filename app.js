//MAJOR
var COEN_MAJOR = ["COEN10", "COEN11","COEN12", "COEN19", "COEN20", "COEN21", "COEN70", "COEN122", "COEN146","COEN171", "COEN174", "COEN175", "COEN177", "COEN179", "COEN194", "COEN195", "COEN196"];
var elen = ["ELEN50","ELEN153"];
var COEN_UPPERDIV_ELECTIVES = ["COEN120","COEN123", "COEN129", "COEN148", "COEN152", "COEN160", "COEN161", "COEN162", "COEN163", "COEN164", "COEN165","COEN166", "COEN169", "COEN178","COEN180"];
var writing=["ENGL181"];
var math=["MATH11","MATH12","MATH13","MATH14","MATH122","AMTH106","AMTH108","MATH53","MATH166","AMTH118"];
...
"SCTR45","SCTR48","SCTR58","SCTR65","TESP45","TESP46","TESP50","TESP60","TESP64","TESP65","TESP71","TESP72","TESP77","TESP79","TESP82","TESP86","TESP88","WGST46","WGST47","WGST48"];
...
"ENGL67","ENGL68","ENGL69","ENGL79G","ENGL122","ENGL122AW","ENGL125","ENGL129","ENGL132G","ENGL135","ENGL136","ENGL138","ENGL152","ETHN5","ETHN10","ETHN20","ETHN30","ETHN35","ETHN36","ETHN40","ETHN41","ETHN50","ETHN51","ETHN65","ETHN70",
"ETHN95","ETHN96","ETHN120","ETHN123","ETHN125","ETHN130","ETHN132","ETHN134","ETHN135","ETHN139","ETHN141","ETHN142","ETHN144","ETHN145","ETHN149","ETHN152","ETHN153","ETHN154","ETHN155","ETHN156","ETHN157","ETHN160","ETHN161","ETHN162","ETHN163",
"ETHN165","ETHN178","HIST84","HIST153","HIST156A","HIST156B","HIST158","HIST172","HIST177","HIST178","HIST180","HIST181","HIST182","HIST183","HIST185","HIST187","HIST188S","ITAL185","LEAD10","LBST106","MUSC20","MUSC132","MUSC134","MUSC196","PHIL70",
...
for(i=0; i<rtc2.length; i++)
{
    if(rtc2[i]==TakenClass)
    {
        ...
        if(TakenClass=="RSOC99"||TakenClass=="TESP43"||TakenClass=="TESP45"||TakenClass=="TESP46"){
        fulfill_type[1]="ELSJ";
        alert(fulfill_type[0]);
        }

        if(TakenClass=="TESP64"||TakenClass=="TESP65"){
        fulfill_type[1]="DIV";
        }
...
for(i=0; i<rtc3.length; i++)
{
    ...
    if(TakenClass=="SCTR128"||TakenClass=="TESP157"||TakenClass=="TESP183"){
    fulfill_type[1]="ELSJ";
    }

    if(TakenClass=="TESP133"){
    fulfill_type[1]="C&I3";
    }

    if(TakenClass=="TESP159"){
    fulfill_type[1]="ETHICS";
    }
...
for(i=0; i<ethics.length; i++)
{
    if(ethics[i]==TakenClass)
    {
        ...
        if(TakenClass=="PSYC114EL" || TakenClass == "PHIL5A"){
        fulfill_type[1]="ELSJ";
        }
...
for(i=0; i<diversity.length; i++)
{
    if(diversity[i]==TakenClass)
    {
        ...
        if(TakenClass=="COMM107A" || TakenClass=="LBST106" || TakenClass =="ETHN160"||
        TakenClass=="ETHN161"||TakenClass=="PHIL70"){
        fulfill_type[1]="ELSJ";
        }
